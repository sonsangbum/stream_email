# 실행은 터미널에서 streamlit run 240621_streamlit_main.py
...
if user_id=='ssb2001' and user_password == "1234" :
    ...
    mclicked =st.sidebar.button("메일 문의")
    # mclicked =st.sidebar.form_submit_button("메일 문의")
    if mclicked : 
        mailsend_240625.Mail_send()
